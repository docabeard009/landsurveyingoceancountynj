...
(function () {
  ...
  var panel=el('<div class="lk-panel" role="dialog" aria-label="Lakeland Surveying chat"><div class="lk-head"><span class="lk-dot" aria-hidden="true"></span><div><b>'+BIZ.name+'</b><span>Ocean &amp; Monmouth Co · online</span></div></div><div class="lk-log" aria-live="polite"></div><div class="lk-chips"></div><form class="lk-foot" autocomplete="off"><input type="text" placeholder="Type your question…" aria-label="Type your question" /><button type="submit" aria-label="Send"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 2 11 13M22 2l-7 20-4-9-9-4z"/></svg></button></form></div>');
